...
public class ChatController {
    ...
    @GetMapping("/movies")
    public List<MovieRecommendation> getMoviewRecommendation(@RequestParam String genre, @RequestParam int count){
        return chatClient.prompt()
                .user(u ->
                        u.text("""
                            ...
                            be the year of the movie released. The data should be absolutely accurate.
                            """).param("genre", genre)
